####################################################################################################################
# Funcion principal encargada de inciar la ejecucion del script
####################################################################################################################
main_research_line <- function(datasets, code, plots, reports){
  ...
  data_prep_and_processing()
  data_clustering()
  additional_datasets_for_reports()
  dimensional_reduction()
  text_reports_generation()
  visual_detailed_reports_generation()
  visual_global_reports_generation()
  extra_variables_mapping()
  register_filtered_data()
}

####################################################################################################################
# Funcion encargada del Importe de librerias, la carga inicial de datasets, y la inicializacion
# de listas de valores de uso comun a lo largo del script
####################################################################################################################
init_data <- function(){
  ...
  # Listas de valores usados para la generacion de reportes visuales
  options(scipen=999)
...
####################################################################################################################
# Funcion encargada de la etapa de pre-tratamiento de datos
####################################################################################################################
data_validation_and_cleaning <- function(){
...
####################################################################################################################
# Funcion encargada de la preparacion y procesamiento de los datos
####################################################################################################################
data_prep_and_processing <- function(){
...
####################################################################################################################
# Funcion encargada del clustering de los datos
####################################################################################################################
data_clustering <- function(){
  ...
  ######La aplicacion de los algoritmos Kmeans y Jerarquico para realizar el Clustering se encuentra a continuacion######
...
####################################################################################################################
# Funcion encargada de los Analisis de Reduccion Diemnsional (PCA y t-SNE)
####################################################################################################################
dimensional_reduction <- function(){
...
####################################################################################################################
# Funcion encargada de la contruccion de datasets adicionales usados para la genereacion de reportes
####################################################################################################################
additional_datasets_for_reports <- function(){
...
####################################################################################################################
# Funcion encargada de la generacion de los reportes de texto
####################################################################################################################
text_reports_generation <- function(){
...
####################################################################################################################
# Funcion encargada de la generacion de los reportes visuales detallados (para cada cluster)
####################################################################################################################
visual_detailed_reports_generation <- function(){
...
####################################################################################################################
# Funcion encargada de la generacion de los reportes visuales globales (de todos los clusters)
####################################################################################################################
visual_global_reports_generation <- function(){
...
####################################################################################################################
# Funcion encargada de la Etapa de Mapeo con Variables Extra (Categorias, Clientes y Sectores economicos)
####################################################################################################################
extra_variables_mapping <- function(){
  # Variables Extra: Sector economico y cliente
...
####################################################################################################################
# Funcion encargada del registro en el reporte de texto de los contratos y clientes filtrados antes del clustering
####################################################################################################################
register_filtered_data <- function(){
