...
####################################################################################################################
# Seccion encargada del Importe de librerias, la carga inicial de datasets, y la inicializacion
...
####################################################################################################################
  ...
  t2 <<- Sys.time()
####################################################################################################################
# Seccion encargada de la etapa de pre-tratamiento de datos
####################################################################################################################
  ...
  t3 <<- Sys.time()
####################################################################################################################
# Seccion encargada de la preparacion y procesamiento de los datos
####################################################################################################################
  ...
  t4 <<- Sys.time()
####################################################################################################################
# Seccion encargada del clustering de los datos
####################################################################################################################
  ...
  t5 <<- Sys.time()
####################################################################################################################
# Seccion encargada de los Analisis de Reduccion Diemnsional (PCA y t-SNE)
####################################################################################################################
  ...
  t6 <<- Sys.time()
####################################################################################################################
# Seccion encargada de la contruccion de datasets adicionales usados para la genereacion de reportes
####################################################################################################################
  ...
  t7 <<- Sys.time()
####################################################################################################################
# Seccion encargada de la generacion de los reportes de texto
####################################################################################################################
  ...
  t8 <<- Sys.time()
####################################################################################################################
# Seccion encargada de la generacion de los reportes visuales detallados (para cada cluster)
####################################################################################################################
  ...
  t9 <<- Sys.time()
####################################################################################################################
# Seccion encargada de la generacion de los reportes visuales globales (de todos los clusters)
####################################################################################################################
  ...
  t10 <<- Sys.time()
####################################################################################################################
# Seccion encargada de la Etapa de Mapeo con Variables Extra (Categorias, Clientes y Sectores economicos)
####################################################################################################################
  ...
  t11 <<- Sys.time()
####################################################################################################################
# Seccion encargada del registro en el reporte de texto de los contratos y clientes filtrados antes del clustering
####################################################################################################################
