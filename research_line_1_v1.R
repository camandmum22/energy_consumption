####################################################################################################################
# Tratamiento de los datos de los consumos de energia activa y reactiva de los clientes no regulados de EPSA.
####################################################################################################################
...
file_report <- paste('C:/Users/Camilo Andres/Desktop/Variety/i2t/plots/',"[hourly_v1].txt",sep='')
...
write('------------------------------------------------------------------------------------------', file_report, append = T)
write.table(group_v2_hclust, file_report, append = T,col.names = T,row.names = F, quote = F,sep = '\t')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       , file_report, append = T,col.names = T,row.names = F, quote = F,sep = '\t')
...
#for(k in 1:length(unique(group_v2$cluster_h))){
  ...
  g1 <- ggplot(m1_segments, aes(x=variable, y=value, colour=ID_CONTRATO)) +geom_quasirandom(size= sizes[2])+ggtitle(paste("Patrones de Consumo, Cluster ",k,lab_clust[1],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
    ...
    stat_summary(fun.y = "median", geom = "line", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_segments)+
  ...
  g1_v2 <- ggplot(m1_segments_v2, aes(x=variable, y=value, colour=ID_CONTRATO)) +geom_quasirandom(size= sizes[2])+ggtitle(paste("Patrones de Consumo, Cluster ",k,lab_clust[1],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
    theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(1, "cm"),legend.title = element_text(size=text_size_v2[2]), legend.position="none",#legend.text =element_text(size = text_size_v2[3]), 
          axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
    stat_summary(fun.y = "median", geom = "line", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_segments_v2)+
  ...
  g2 <- ggplot(m1_days, aes(x=variable, y=value, colour=ID_CONTRATO)) +geom_quasirandom(size= sizes[2])+ggtitle(paste("Patrones de Consumo, Cluster ",k,lab_clust[1],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
    theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(1, "cm"),legend.title = element_text(size=text_size_v2[2]), legend.position="none",#legend.text =element_text(size = text_size_v2[3]), 
          axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
    stat_summary(fun.y = "median",  geom = "line", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_days)+
  ...
  g3 <- ggplot(m1_months, aes(x=variable, y=value, colour=ID_CONTRATO)) +geom_quasirandom(size= sizes[2])+ggtitle(paste("Patrones de Consumo, Cluster ",k,lab_clust[1],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
    theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(1, "cm"),legend.title = element_text(size=text_size_v2[2]), legend.position="none",#legend.text =element_text(size = text_size_v2[3]), 
          axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
    stat_summary(fun.y = "median",  geom = "line", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_months)+
  ...
  g5 <- ggplot(m1_hours, aes(x=variable, y=value, colour=ID_CONTRATO)) +geom_quasirandom(size= sizes[2])+ggtitle(paste("Patrones de Consumo, Cluster ",k,lab_clust[1],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
    theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(1, "cm"),legend.title = element_text(size=text_size_v2[2]), legend.position="none",#legend.text =element_text(size = text_size_v2[3]), 
          axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
    stat_summary(fun.y = "median",  geom = "line", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_hours)+
...
melt_v1_com <- melt(group_v2_hclust, id.vars=c("cluster"))
m1_segments <- melt_v1[substring(melt_v1$variable, 1, 2)=='fc',]
m1_segments_v2 <- melt_v1[substring(melt_v1$variable, 1, 2)=='fi',]
m1_days <- melt_v1[substring(melt_v1$variable, 1, 1)=='d',]
m1_months <- melt_v1[substring(melt_v1$variable, 1, 1)=='m',]
...
# m2_scale <- -qt(c(0.025,0.05,0.1), df=nrow(m2_total)-1)*(sd(m2_total$value)/sqrt(nrow(m2_total)))
#geom_quasirandom(dodge.width=0.5)
g1 <- ggplot(m1_segments, aes(x=variable, y=value, colour=cluster)) +geom_line(size= sizes[2])+ggtitle(paste('Panorama General de Patrones de Consumo ',lab_clust[1],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median", geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_segments)+
  scale_y_continuous(breaks = seq(min(m1_segments$value,0), max(m1_segments$value), by = round(max(m1_segments$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m1_ncol))
g1_v2 <- ggplot(m1_segments_v2, aes(x=variable, y=value, colour=cluster)) +geom_line(size= sizes[2])+ggtitle(paste('Panorama General de Patrones de Consumo ',lab_clust[1],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median", geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_segments_v2)+
  scale_y_continuous(breaks = seq(min(m1_segments$value,0), max(m1_segments$value), by = round(max(m1_segments$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m1_ncol))
g2 <- ggplot(m1_days, aes(x=variable, y=value, colour=cluster)) +geom_line(size= sizes[2])+ggtitle(paste('Panorama General de Patrones de Consumo ',lab_clust[1],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median",  geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_days)+
  scale_y_continuous(breaks = seq(min(m1_days$value,0), max(m1_days$value), by = round(max(m1_days$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m1_ncol))
g3 <- ggplot(m1_months, aes(x=variable, y=value, colour=cluster)) +geom_line(size= sizes[2])+ggtitle(paste('Panorama General de Patrones de Consumo ',lab_clust[1],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median",  geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_months)+
  scale_y_continuous(breaks = seq(min(m1_months$value,0), max(m1_months$value), by = round(max(m1_months$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m1_ncol))
g4 <- ggplot(m1_hours, aes(x=variable, y=value, colour=cluster)) +geom_line(size= sizes[2])+ggtitle(paste('Panorama General de Patrones de Consumo ',lab_clust[1],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median",  geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_hours)+
  scale_y_continuous(breaks = seq(min(m1_hours$value,0), max(m1_hours$value), by = round(max(m1_hours$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m1_ncol))

g5 <- ggplot(m2_segments, aes(x=variable, y=value, colour=cluster)) +geom_line(size= sizes[2])+ggtitle(paste('Panorama General de Patrones de Consumo ',lab_clust[2],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median", geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_segments)+
  scale_y_continuous(breaks = seq(min(m2_segments$value,0), max(m2_segments$value), by = round(max(m2_segments$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m2_ncol))
g5_v2 <- ggplot(m2_segments_v2, aes(x=variable, y=value, colour=cluster)) +geom_line(size= sizes[2])+ggtitle(paste('Panorama General de Patrones de Consumo ',lab_clust[2],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median", geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_segments_v2)+
  scale_y_continuous(breaks = seq(min(m2_segments$value,0), max(m2_segments$value), by = round(max(m2_segments$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m2_ncol))
g6 <- ggplot(m2_days, aes(x=variable, y=value, colour=cluster)) +geom_line(size= sizes[2])+ggtitle(paste('Panorama General de Patrones de Consumo ',lab_clust[2],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median",  geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_days)+
  scale_y_continuous(breaks = seq(min(m2_days$value,0), max(m2_days$value), by = round(max(m2_days$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m2_ncol))
g7 <- ggplot(m2_months, aes(x=variable, y=value, colour=cluster)) +geom_line(size= sizes[2])+ggtitle(paste('Panorama General de Patrones de Consumo ',lab_clust[2],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median",  geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_months)+
  scale_y_continuous(breaks = seq(min(m2_months$value,0), max(m2_months$value), by = round(max(m2_months$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m2_ncol))
g8 <- ggplot(m2_hours, aes(x=variable, y=value, colour=cluster)) +geom_line(size= sizes[2])+ggtitle(paste('Panorama General de Patrones de Consumo ',lab_clust[2],sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median",  geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_hours)+
  scale_y_continuous(breaks = seq(min(m2_hours$value,0), max(m2_hours$value), by = round(max(m2_hours$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m2_ncol))
...
png(paste(dir_plots,"global_hclust_heat_sectors_global",'.png',sep = ''), width=plot_dim[1], height=plot_dim[2])
plot(g1)
dev.off()
png(paste(dir_plots,"global_kmeans_heat_sectors_global",'.png',sep = ''), width=plot_dim[1], height=plot_dim[2])
plot(g2)
dev.off()
png(paste(dir_plots,"global_hclust_heat_clients_global",'.png',sep = ''), width=plot_dim[1], height=plot_dim[2])
plot(g3)
dev.off()
png(paste(dir_plots,"global_kmeans_heat_clients_global",'.png',sep = ''), width=plot_dim[1], height=plot_dim[2])
plot(g4)
dev.off()

bd_hourly$COD_CLI <- bd_daily[match(bd_hourly$SUMI_SGC_NIC, bd_daily$ID_CONTRATO),1]
s_pre <-  as.data.frame(summarize(group_by(bd_hourly, COD_CLI), count=length(unique(SUMI_SGC_NIC)), contratos=paste(unique(SUMI_SGC_NIC),collapse=" ")))
...
write('------------------------------------------------------------------------------------------', file_report, append = T)
write('-----------------Preservacion de Contratos Luego de Limpieza-----------------', file_report, append = T)
write('------------------------------------------------------------------------------------------', file_report, append = T)
for(x in 1:nrow(s_pre)){
  client <- as.character(s_pre$COD_CLI[x])
  cont_1 <- sort(strsplit(s_pre$contratos[x], " ")[[1]])
  cont_2 <- sort(strsplit(s_post[as.character(s_post$COD_CLI==client),3], " ")[[1]])
  
  if(!identical(cont_1,cont_2)){
    write(paste('-----Cliente -> ',clients_v1[clients_v1$COD_CLI==client,3],sep=''), file_report, append = T,sep = '\t')
...
g1 <- ggplot(m1_hours, aes(x=variable, y=value, colour=ID_CONTRATO)) +geom_line(size= sizes[2])+ggtitle(paste('Caso de Interes ',case,'\n',sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median",  geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_hours)+
  scale_y_continuous(breaks = seq(min(m1_hours$value,0), max(m1_hours$value), by = round(max(m1_hours$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m1_ncol))
g2 <- ggplot(m1_days, aes(x=variable, y=value, colour=ID_CONTRATO)) +geom_line(size= sizes[2])+ggtitle(paste('Caso de Interes ',case,'\n',sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median",  geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_days)+
  scale_y_continuous(breaks = seq(min(m1_days$value,0), max(m1_days$value), by = round(max(m1_days$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m1_ncol))
g3 <- ggplot(m1_months, aes(x=variable, y=value, colour=ID_CONTRATO)) +geom_line(size= sizes[2])+ggtitle(paste('Caso de Interes ',case,'\n',sep = ""))+labs(x="\nPeriodo",y="% Consumo\n")+
  theme(plot.title = element_text(size = text_size_v2[1],hjust = 0.5),legend.key.size = unit(2, "cm"),legend.title = element_text(size=text_size_v2[2]*2), legend.text =element_text(size = text_size_v2[3]*2), 
        axis.title = element_text(size=text_size_v2[4]), axis.text.x = element_text(size=text_size_v2[5]), axis.text.y = element_text(size=text_size_v2[6]))+
  stat_summary(fun.y = "median",  geom = "point", color = "orange", size = sizes[1])+scale_x_discrete(limits=lab_months)+
  scale_y_continuous(breaks = seq(min(m1_months$value,0), max(m1_months$value), by = round(max(m1_months$value)*sizes[4],2)))+guides(colour=guide_legend(ncol=m1_ncol))
